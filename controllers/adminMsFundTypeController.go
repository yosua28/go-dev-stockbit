...
func AdminGetListMsFundType(c echo.Context) error {
	var err error
	var status int
	...
	items := []string{"fund_type_key", "fund_type_code", "fund_type_name"}
	...
	var responseData []models.MsFundTypeInfo

	for _, fund := range fundType {
		var data models.MsFundTypeInfo
