...
func GetAdminCmsFinancialCalcList(c echo.Context) error {
	...
	items := []string{"calc_key", "user_login_name", "customer_name", "customer_role", "purpose_code", "purpose_name",
		"purpose_desc", "invest_target", "invest_return", "invest_period", "result_invest", "result_remakrs"}
	...
	responseData := cmsFinancialCalcList

	var countData models.CmsFinancialCalcCount
	var pagination int
	if limit > 0 {
